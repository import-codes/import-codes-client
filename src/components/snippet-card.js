    ...
    return (
        <div className='bg-white rounded-lg text-left overflow-hidden shadow'>
            ...
            <div class='flex flex-col items-start px-4 py-4'>
                <h3 class='text-lg leading-6 font-medium text-gray-900 mb-4' id='modal-headline'>{props.title}</h3>
                <p class='text-sm leading-5 text-gray-500 font-mono '>{props.description}</p>
            </div>
